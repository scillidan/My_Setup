...
Global GoldenDictFileName := "D:\scoop\apps\goldendict\current\GoldenDict.exe"
Global MdictFileName := "C:\Program Files\MDictPC\MDict.exe"
Global EudicFileName := "C:\Program Files (x86)\eudic\eudic.exe"
Global Capture2TextFileName := "D:\scoop\apps\capture2text\current\Capture2Text.exe"
...
^!+c::  ; Start box capture by pressing ctrl + `
BoxCapture() {
    If !WinExist("ahk_exe Capture2Text.exe") {
