...
set "NVM_HOME=%HOME%\.nvm%NVM_HOME%"
set "NVM_SYMLINK=C:\Program Files\nodejs%NVM_SYMLINK%"
set "SYS_ARCH=64%SYS_ARCH%"
set "PNPM_HOME=%HOME%\AppData\Roaming\pnpm%PNPM_HOME%"
...
:: set "GOROOT=%GOROOT%"
:: "RBENV_USE_MIRROR=CN%RBENV_USE_MIRROR%"

:: set "LUA_PATH_5_3=%HOME%\Lib\lua53\x64%LUA_PATH_5_3%"
:: set "LUA_CPATH_5_3=%HOME%\Lib\lua53\x64%LUA_CPATH_5_3%"
:: set "GH_CONFIG_DIR=%HOME%\.config\gh%GH_CONFIG_DIR%"

:: rime-ls
:: set "LIBRIME_LIB_DIR=%HOME%\Lib\rime\dist\lib%LIBRIME_LIB_DIR%"
:: set "LIBRIME_INCLUDE_DIR=%HOME%\Lib\rime\dist\include%LIBRIME_INCLUDE_DIR%"
:: set "LIB=%HOME%\Lib\rime\dist\lib%LIB%"

:: avante.nvim
:: OPENAI_API_KEY=

:: dedoc
set "DEDOC_HOME=%HOME%\Data\dedoc%DEDOC_HOME%"
...
set "ALASS_FFMPEG_PATH=%HOME%\Lib\ffmpeg\bin\ffmpeg.exe%ALASS_FFMPEG_PATH%"
set "ALASS_FFPROBE_PATH=%HOME%\Lib\ffmpeg\bin\ffprobe.exe%ALASS_FFPROBE_PATH%"
...
:: set "XDG_CONFIG_HOME=%HOME%\AppData\Local%XDG_CONFIG_HOME%"
...
:: wim
:: set "PYTHONHOME=%LocalAppData%\Programs\Python\Python310%PYTHONHOME%"
:: set "PYTHONPATH=%LocalAppData%\Programs\Python\Python310\python.exe%PYTHONPATH%"
:: set "PYTHONIOENCODING=UTF-8%PYTHONIOENCODING%"
:: set "DYNAMIC_PYTHON3_DLL=%LocalAppData%\Programs\Python\Python310\python310.dll%DYNAMIC_PYTHON3_DLL%"
